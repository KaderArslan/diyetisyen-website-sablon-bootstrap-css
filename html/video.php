       ...
       <ul class="navbar-nav text-nav ms-auto mb-2 mb-lg-0">
         ...
         <li class="nav-item me-1 dropdown">
          ...
          <ul class="dropdown-menu dropdownshadow border-0" >
            ...
            <li><a class="nav-link-dropdown active dropdown-item" href="#">video</a></li>
  ...
  <div class="row">
    ...
    <div class="row order-2 order-sm-1">
      ...
      <div class="col-md-9 text-center mt-3 mt-sm-0">
        ...
        <h1 class="text-center fw-bold mb-3">Video</h1>
      </div>
    </div>
    ...
    <div class="col-md-3 order-1 order-sm-2">
      <ul class="list-group border">
        ...
        <li class="list-group-item active">
            <a class="text-white" href="#"><i class="fas fa-angle-right"></i> video</a></li>
        <li class="list-group-item">
            <a class="text-dark" href="galeri.php"><i class="fas fa-angle-right"></i> galeri</a></li>
    </ul>
    </div>
    <div class="col-md-9 order-3 order-sm-3">
          <p class="text-start mb-3">Lorem Ipsum pasajlarının birçok çeşitlemesi vardır. Ancak bunların büyük bir çoğunluğu mizah katılarak
      ...
      <div class="row mb-3">
        <div class="col-md-12 mt-3">
            <iframe class="rounded"  height="315" src="https://www.youtube.com/embed/GPH17oNsUY4" style="width:100% !important;" title="YouTube video player"  allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        </div>
      </div>
      ...
      <div class="row">
        <div class="col-md mt-3">
          <div class="card mb-2 border-0">
            <div class="row g-0">
                <iframe class="rounded" src="https://www.youtube.com/embed/M4U545NB88o" title="YouTube video player" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
              
                  <h5 class="mt-3">İradeni Güçlendirecek 5 Yol</h5>
                  <p class="">1500'lerden beri kullanılmakta olan standard Lorem Ipsum metinleri ilgilenenler için yeniden üretilmiştir.</p>
            </div>
          </div>
        </div>
        ...
        <div class="col-md mt-3">
          <div class="card mb-2 border-0">
            <div class="row g-0">
              <iframe class="rounded" src="https://www.youtube.com/embed/30zCifhCVlU" title="YouTube video player" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
      ...
      <div class="row">
        ...
        <div class="col-md mb-2 mt-3">
          <div class="card border-0">
            <div class="row g-0">
              <iframe class="rounded" src="https://www.youtube.com/embed/3X1QcN6XSRc" title="YouTube video player" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        ...
        <div class="col-md mt-3">
          <div class="card mb-2 border-0">
            <div class="row g-0">
              <iframe class="rounded" src="https://www.youtube.com/embed/qejbHunEKOg" title="YouTube video player" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
      ...
      <div class="row">
        <div class="col-md mt-3">
          <div class="card border-0">
            <div class="row g-0">
              <iframe class="rounded" src="https://www.youtube.com/embed/FXH98AslzgQ" title="YouTube video player" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        ...
        <div class="col-md mt-3">
          <div class="card border-0">
            <div class="row g-0">
              <iframe class="rounded" src="https://www.youtube.com/embed/1FSP51ouduk" title="YouTube video player" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
