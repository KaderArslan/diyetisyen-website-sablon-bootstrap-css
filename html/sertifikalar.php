          ...
          <div class="row row-cols-1 row-cols-md-3">
            <div class="col mt-3">
              <div class="card border-0">
                ...
                <div class="mt-2">
                  <h5 class="card-title">Uzmanlık Belgesi</h5>
                  <p class="card-text mb-2">Yaygın inancın tersine, Lorem Ipsum rastgele sözcüklerden oluşmaz.</p>
                </div>
              </div>
            </div>
            <div class="col mt-3">
              <div class="card border-0">
                ...
                <div class="mt-2">
                  <h5 class="card-title">Üni. Diploması</h5>
                  <p class="card-text mb-2">Yaygın inancın tersine, Lorem Ipsum rastgele sözcüklerden oluşmaz.</p>
                </div>
              </div>
            </div>
            ...
            <div class="col mt-3">
              <div class="card border-0">
                ...
                <div class="mt-2">
                  <h5 class="card-title">Üni. Sempozyumu</h5>
