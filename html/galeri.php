       ...
       <ul class="navbar-nav text-nav ms-auto mb-2 mb-lg-0">
         ...
         <li class="nav-item me-1 dropdown">
          ...
          <ul class="dropdown-menu dropdownshadow border-0" >
            ...
            <li><a class="nav-link-dropdown active dropdown-item" href="#">galeri</a></li>
          </ul>
        </li>
         <li class="nav-item">
  ...
  <div class="row">
    ...
    <div class="row order-2 order-sm-1">
      ...
      <div class="col-md-9 text-center mt-3 mt-sm-0">
        ...
        <h1 class="text-center fw-bold mb-3">Galeri</h1>
      </div>
    </div>
    ...
    <div class="col-md-3 order-1 order-sm-2">
      <ul class="list-group border">
        ...
        <li class="list-group-item active">
            <a class="text-white" href="#"><i class="fas fa-angle-right"></i> galeri</a></li>
    </ul>
    </div>
    ...
    <div class="col-md-9 text-center order-3 order-sm-3">
      ...
      <div class="row">
        ...
        <div class="col-md mb-2 mt-3">
          <div class="card border-0">
            <a href="../images/mehtap-erciyes-galeri.jpg" data-fancybox="galeri" data-width="1500" data-height="1000">
              <img src="../images/mehtap-erciyes-galeri.jpg" class="card-img-top w-100 image-shadow rounded rounded" alt="lorem ipsum lorem ipsum"/>
            </a>
          </div>
        </div>
        ...
        <div class="col-md-3 mt-3">
          <div class="row">
            <div class="card border-0" >
              <a href="../images/mehtap-erciyes-galeri-2.jpg" data-fancybox="galeri" data-width="1500" data-height="1000">
                <img src="../images/mehtap-erciyes-galeri-2.jpg" class="card-img-top w-100 image-shadow rounded" alt="lorem ipsum lorem ipsum"/>
              </a>
            </div>
          </div>
          <div class="row mt-4">
            <div class="card border-0 mb-2">
              <a href="../images/mehtap-erciyes-galeri-4.jpg" data-fancybox="galeri" data-width="1500" data-height="1000">
                <img src="../images/mehtap-erciyes-galeri-4.jpg" class="card-img-top w-100 image-shadow rounded" alt="lorem ipsum lorem ipsum"/>
              </a>
            </div>
          </div>
        </div>
        ...
        <div class="col-md-3 mt-3">
          <div class="row">
            <div class="card border-0" >
              <a href="../images/mehtap-erciyes-galeri-3.jpg" data-fancybox="galeri" data-width="1500" data-height="1000">
                <img src="../images/mehtap-erciyes-galeri-3.jpg" class="card-img-top w-100 image-shadow rounded" alt="lorem ipsum lorem ipsum"/>
              </a>
            </div>
          </div>
          <div class="row mt-4">
            <div class="card border-0 mb-2">
              <a href="../images/mehtap-erciyes-galeri-5.jpg" data-fancybox="galeri" data-width="1500" data-height="1000">
                <img src="../images/mehtap-erciyes-galeri-5.jpg" class="card-img-top w-100 image-shadow rounded" alt="lorem ipsum lorem ipsum"/>
              </a>
            </div>
          </div>
        </div>
      ...
      <div class="row mt-3">  
        ...
        <div class="col-md-3">
          <div class="row">
            <div class="card border-0" >
              <a href="../images/mehtap-erciyes-galeri-6.jpg"  data-fancybox="galeri" data-width="1500" data-height="1000">
                <img src="../images/mehtap-erciyes-galeri-6.jpg" class="card-img-top w-100 image-shadow rounded" alt="lorem ipsum lorem ipsum"/>
              </a>
            </div>
          </div>
          <div class="row mt-4">
            <div class="card border-0 mb-2">
              <a href="../images/mehtap-erciyes-galeri-8.jpg"  data-fancybox="galeri" data-width="1500" data-height="1000">
                <img src="../images/mehtap-erciyes-galeri-8.jpg" class="card-img-top w-100 image-shadow rounded" alt="lorem ipsum lorem ipsum"/>
              </a>
            </div>
          </div>
        </div>
        ...
        <div class="col-md-3">
          <div class="row">
            <div class="card border-0" >
              <a href="../images/mehtap-erciyes-galeri-7.jpg"  data-fancybox="galeri" data-width="1500" data-height="1000">
                <img src="../images/mehtap-erciyes-galeri-7.jpg" class="card-img-top w-100 image-shadow rounded" alt="lorem ipsum lorem ipsum"/>
              </a>
            </div>
          </div>
          <div class="row mt-4">
            <div class="card border-0 mb-2">
              <a href="../images/mehtap-erciyes-galeri-9.jpg"  data-fancybox="galeri" data-width="1500" data-height="1000">
                <img src="../images/mehtap-erciyes-galeri-9.jpg" class="card-img-top w-100 image-shadow rounded" alt="lorem ipsum lorem ipsum"/>
              </a>
            </div>
          </div>
        </div>
        ...
        <div class="col-md mb-2">
            <div class="card border-0">
              <a href="../images/mehtap-erciyes-galeri-10.jpg"  data-fancybox="galeri" data-width="1500" data-height="1000">
                <img src="../images/mehtap-erciyes-galeri-10.jpg" class="card-img-top w-100 image-shadow rounded" alt="lorem ipsum lorem ipsum"/>
              </a>
            </div>
        </div>
