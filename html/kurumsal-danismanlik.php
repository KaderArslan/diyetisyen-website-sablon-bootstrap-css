...
<head>
    ...
    <!-- CSS -->
    <link rel="stylesheet" href="../css/hizmetlerimiz-detay.css">
    ...
    <title>Hizmetlerimiz Detay</title>
        ...
        <div class="col-md-12">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item text-dark"><a href="hizmetlerimiz.php">hizmetlerimiz</a></li>
    ...
    <div class="row">
      ...
      <div class="row">
        ...
        <div class="col-md-9 text-center">
          ...
          <h1 class="text-center fw-bold mb-3">Kurumsal Danışmanlık</h1>
        </div>
      </div>
  
      <div class="col-md-3 order-2 order-sm-1  mt-3 mt-sm-0">
        <ul class="list-group border">
          <li class="list-group-item active">
              <a class="text-white" href="#"><i class="fas fa-angle-right"></i> Kurumsal Danışmanlık</a>
          </li>
          <li class="list-group-item">
              <a class="text-dark" href="#"><i class="fas fa-angle-right"></i> Sağlıklı Yaşam Danışmanlığı</a></li>
          <li class="list-group-item">
              <a class="text-dark" href="#"><i class="fas fa-angle-right"></i> Yaşam Koçluğu</a></li>
              <li class="list-group-item">
                <a class="text-dark" href="#"><i class="fas fa-angle-right"></i> Kilo Verme & Kilo Alma Diyeti</a>
            </li>
            <li class="list-group-item">
                <a class="text-dark" href="#"><i class="fas fa-angle-right"></i> Kişiye Özel Diyet Programı</a></li>
            <li class="list-group-item">
                <a class="text-dark" href="#"><i class="fas fa-angle-right"></i> Metabolizma Hızı Ölçümü</a></li>
                <li class="list-group-item">
                    <a class="text-dark" href="#"><i class="fas fa-angle-right"></i> Diyabet ve Diyet Takibi</a>
                </li>
                <li class="list-group-item">
                    <a class="text-dark" href="#"><i class="fas fa-angle-right"></i> Çocuk ve Ergenlerde Kilo Kontrolü</a></li>
                <li class="list-group-item">
                    <a class="text-dark" href="#"><i class="fas fa-angle-right"></i> Troid Hastalarında Beslenme</a></li>
                    <li class="list-group-item">
                        <a class="text-dark" href="#"><i class="fas fa-angle-right"></i> Kilo Alma Diyetleri</a>
                    </li>
                    <li class="list-group-item">
                        <a class="text-dark" href="#"><i class="fas fa-angle-right"></i> Çölyak Hastalığında Beslenme</a></li>
                    <li class="list-group-item">
                        <a class="text-dark" href="#"><i class="fas fa-angle-right"></i> Gebelik Ve Emziklilikte Beslenme</a></li>
          <li class="list-group-item">
              <a class="text-dark" href="#"><i class="fas fa-angle-right"></i> Hastalıklarda Tıbbi Beslenme</a></li>
      </ul>
          
      </div>
  
        <div class="col-md-9 text-start order-1 order-sm-2">
            <span class="fw-bold text-dark">Nereden Gelir</span>
            <p class="mt-3">Yaygın inancın tersine, Lorem Ipsum rastgele sözcüklerden oluşmaz. Kökleri M.Ö. 45 tarihinden bu yana klasik Latin edebiyatına kadar uzanan 2000 yıllık bir geçmişi vardır. Virginia'daki Hampden-Sydney College'dan Latince profesörü Richard McClintock, bir Lorem Ipsum pasajında geçen ve anlaşılması en güç sözcüklerden biri olan 'consectetur' sözcüğünün klasik edebiyattaki örneklerini incelediğinde kesin bir kaynağa ulaşmıştır. Lorm Ipsum, Çiçero tarafından M.Ö. 45 tarihinde kaleme alınan "de Finibus Bonorum et Malorum" (İyi ve Kötünün Uç Sınırları) eserinin 1.10.32 ve 1.10.33 sayılı bölümlerinden gelmektedir. Bu kitap, ahlak kuramı üzerine bir tezdir ve Rönesans döneminde çok popüler olmuştur. Lorem Ipsum pasajının ilk satırı olan "Lorem ipsum dolor sit amet" 1.10.32 sayılı bölümdeki bir satırdan gelmektedir.</p>
  
            <p class="text-start">1500'lerden beri kullanılmakta olan standard Lorem Ipsum metinleri ilgilenenler için yeniden üretilmiştir. Çiçero tarafından yazılan 1.10.32 ve 1.10.33 bölümleri de 1914 H. Rackham çevirisinden alınan İngilizce sürümleri eşliğinde özgün biçiminden yeniden üretilmiştir.</p>

            <span class="fw-bold mt-3 text-dark">Lorem Ipsum Nedir?</span>
            <p class="mt-3">Lorem Ipsum, dizgi ve baskı endüstrisinde kullanılan mıgır metinlerdir. Lorem Ipsum, adı bilinmeyen bir matbaacının bir hurufat numune kitabı oluşturmak üzere bir yazı galerisini alarak karıştırdığı 1500'lerden beri endüstri standardı sahte metinler olarak kullanılmıştır. Beşyüz yıl boyunca varlığını sürdürmekle kalmamış, aynı zamanda pek değişmeden elektronik dizgiye de sıçramıştır. 1960'larda Lorem Ipsum pasajları da içeren Letraset yapraklarının yayınlanması ile ve yakın zamanda Aldus PageMaker gibi Lorem Ipsum sürümleri içeren masaüstü yayıncılık yazılımları ile popüler olmuştur.</p>
  
            <span class="fw-bold mt-3 text-dark">Neden Kullanırız?</span>
            <p class="mt-3">Yinelenen bir sayfa içeriğinin okuyucunun dikkatini dağıttığı bilinen bir gerçektir. Lorem Ipsum kullanmanın amacı, sürekli 'buraya metin gelecek, buraya metin gelecek' yazmaya kıyasla daha dengeli bir harf dağılımı sağlayarak okunurluğu artırmasıdır. Şu anda birçok masaüstü yayıncılık paketi ve web sayfa düzenleyicisi, varsayılan mıgır metinler olarak Lorem Ipsum kullanmaktadır. Ayrıca arama motorlarında 'lorem ipsum' anahtar sözcükleri ile arama yapıldığında henüz tasarım aşamasında olan çok sayıda site listelenir. Yıllar içinde, bazen kazara, bazen bilinçli olarak (örneğin mizah katılarak), çeşitli sürümleri geliştirilmiştir.</p>

            <span class="fw-bold mt-3 text-dark">Nereden Bulabilirim?</span>
            <p class="mt-3">Lorem Ipsum pasajlarının birçok çeşitlemesi vardır. Ancak bunların büyük bir çoğunluğu mizah katılarak veya rastgele sözcükler eklenerek değiştirilmişlerdir. Eğer bir Lorem Ipsum pasajı kullanacaksanız, metin aralarına utandırıcı sözcükler gizlenmediğinden emin olmanız gerekir. İnternet'teki tüm Lorem Ipsum üreteçleri önceden belirlenmiş metin bloklarını yineler. Bu da, bu üreteci İnternet üzerindeki gerçek Lorem Ipsum üreteci yapar. Bu üreteç, 200'den fazla Latince sözcük ve onlara ait cümle yapılarını içeren bir sözlük kullanır. Bu nedenle, üretilen Lorem Ipsum metinleri yinelemelerden, mizahtan ve karakteristik olmayan sözcüklerden uzaktır.</p>

            <div class="row">
              <div class="col mt-3">
                <div class="card border-0">
                  <a href="../images/kurumsal-danismanlik.jpg" data-fancybox="kurumsal-danismanlik" data-width="500" data-height="500">
                    <img src="../images/kurumsal-danismanlik.jpg" class="card-img-top w-100 rounded" alt="lorem ipsum lorem ipsum"/>
                  </a>
                </div>
              </div>
              <div class="col mt-3">
                <div class="card border-0">
                  <a href="../images/kurumsal-danismanlik-2.jpg" data-fancybox="kurumsal-danismanlik" data-width="500" data-height="500">
                    <img src="../images/kurumsal-danismanlik-2.jpg" class="card-img-top w-100 rounded" alt="lorem ipsum lorem ipsum"/>
                  </a>   
                </div>
              </div>
              <div class="col mt-3">
                <div class="card border-0">
                  <a href="../images/kurumsal-danismanlik-3.jpg" data-fancybox="kurumsal-danismanlik" data-width="500" data-height="500">
                    <img src="../images/kurumsal-danismanlik-3.jpg" class="card-img-top w-100 rounded" alt="lorem ipsum lorem ipsum"/>
                  </a>
                </div>
              </div>
              <div class="col mt-3">
                <div class="card border-0">
                  <a href="../images/kurumsal-danismanlik-4.jpg" data-fancybox="kurumsal-danismanlik" data-width="500" data-height="500">
                    <img src="../images/kurumsal-danismanlik-4.jpg" class="card-img-top w-100 rounded" alt="lorem ipsum lorem ipsum"/>
                  </a>
                </div>
              </div>
            ...
            <div class="row">
              <div class="col-md">
                <div class=" text-start text-dark">
                  <h5 class="fw-bold mt-3">Diğer Hizmetlerimiz</h5>
                </div>
              </div>
            </div>
            ...
            <div class="row justify-content-center">
              <div class="col-md-4">
                <div class="card mt-3 h-100">
                  <div class="imageoverlay">
                    <img src="../images/kurumsal-danismanlik.jpg" class="card-img-top blog-shadow image" alt="Lorem, ipsum dolor.">
                    <div class="middle">
                    ...
                    <div class="text-start card-body">
                      <h5 class="fw-bold">Sağlıklı Yaşam Danışmanlığı</h5>
              ...
              <div class="col-md-4">
                <div class="card mt-3 h-100">
                  <div class="imageoverlay">
                    <img src="../images/kurumsal-danismanlik-2.jpg" class="card-img-top blog-shadow image" alt="Lorem, ipsum dolor.">
                    <div class="middle">
                      <div class="text rounded">
                        <a class="text-white" href="#">incele</a>
                      </div>
                    ...
                    <div class="text-start card-body">
                      <h5 class="fw-bold">Yaşam Koçluğu</h5>
                      <p class="">1500'lerden beri kullanılmakta olan standard Lorem Ipsum metinleri...</p>
                    </div>
                  </div>
            </div>
            <div class="col-md-4">
              <div class="card mt-3 h-100">
                <div class="imageoverlay">
                  <img src="../images/kurumsal-danismanlik-3.jpg" class="card-img-top blog-shadow image" alt="Lorem, ipsum dolor.">
                  <div class="middle">
                    <div class="text rounded">
                      <a class="text-white" href="#">incele</a>
                    </div>
                  ...
                  <div class="text-start card-body">
                    <h5 class="fw-bold">Kilo Verme & Kilo Alma Diyeti</h5>
                    <p class="">1500'lerden beri kullanılmakta olan standard Lorem Ipsum metinleri...</p>
                  </div>
                </div>
          </div>
